...
- 2026-06-19: confirmed 2026-06-19 release; all 3 LTS images published (bluefin-lts, bluefin-lts-hwe, bluefin-lts-hwe-nvidia :lts/:stable/:testing); deleted stale bluefin-lts-nvidia package; fixed skill docs: no lts-YYYYMMDD tag is created by execute-release.yml (floating :lts only), rollback anchor is testing.YYYYMMDD, build-gdx.yml → build-nvidia.yml ([#296](https://github.com/projectbluefin/bluefin-lts/pull/296))
